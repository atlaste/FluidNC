// Copyright (c) 2013 Jerry Adair
// Copyright (c) 2025 Atlas - Adapted for FluidNC
...
class FM25VXX {
public:
    FM25VXX(uint8_t csPin, uint8_t wPin, uint8_t holdPin, uint32_t fence, uint32_t spiFreqHz);
    ~FM25VXX();
