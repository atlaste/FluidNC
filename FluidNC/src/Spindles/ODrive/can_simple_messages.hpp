...
namespace Spindles::ODrive {
    struct Get_Version_msg_t final {
        ...
        void decode_msg(const TBoard::TCanIntf::TMsg& msg) { decode_buf(can_msg_get_payload(msg).data()); }
#endif
    ...
    struct Set_Axis_State_msg_t final {
        ...
        void encode_buf(uint8_t* buf) const { can_set_signal_raw<uint32_t>(buf, Axis_Requested_State, 0, 32, true); }

        void decode_buf(const uint8_t* buf) { Axis_Requested_State = can_get_signal_raw<uint32_t>(buf, 0, 32, true); }
    ...
    struct Set_Input_Torque_msg_t final {
        ...
        void encode_buf(uint8_t* buf) const { can_set_signal_raw<float>(buf, Input_Torque, 0, 32, true); }

        void decode_buf(const uint8_t* buf) { Input_Torque = can_get_signal_raw<float>(buf, 0, 32, true); }
    ...
    struct Set_Traj_Vel_Limit_msg_t final {
        ...
        void encode_buf(uint8_t* buf) const { can_set_signal_raw<float>(buf, Traj_Vel_Limit, 0, 32, true); }

        void decode_buf(const uint8_t* buf) { Traj_Vel_Limit = can_get_signal_raw<float>(buf, 0, 32, true); }
    ...
    struct Set_Traj_Inertia_msg_t final {
        ...
        void encode_buf(uint8_t* buf) const { can_set_signal_raw<float>(buf, Traj_Inertia, 0, 32, true); }

        void decode_buf(const uint8_t* buf) { Traj_Inertia = can_get_signal_raw<float>(buf, 0, 32, true); }
