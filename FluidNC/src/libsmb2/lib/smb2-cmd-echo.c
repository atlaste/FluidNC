...
static int smb2_encode_echo_request(struct smb2_context* smb2, struct smb2_pdu* pdu) {
    uint8_t*           buf;
    int                len;
...
struct smb2_pdu* smb2_cmd_echo_async(struct smb2_context* smb2, smb2_command_cb cb, void* cb_data) {
    struct smb2_pdu* pdu;
...
int smb2_process_echo_fixed(struct smb2_context* smb2, struct smb2_pdu* pdu) {
    return 0;
}
