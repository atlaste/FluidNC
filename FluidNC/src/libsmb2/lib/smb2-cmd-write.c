...
static int smb2_encode_write_request(struct smb2_context* smb2, struct smb2_pdu* pdu, struct smb2_write_request* req) {
    int                len;
    uint8_t*           buf;
...
struct smb2_pdu* smb2_cmd_write_async(struct smb2_context* smb2, struct smb2_write_request* req, smb2_command_cb cb, void* cb_data) {
    struct smb2_pdu* pdu;
    ...
    smb2_add_iovector(smb2, &pdu->out, (uint8_t*)req->buf, req->length, NULL);
...
int smb2_process_write_fixed(struct smb2_context* smb2, struct smb2_pdu* pdu) {
