...
#include <stdio.h>
static int smb2_encode_set_info_request(struct smb2_context* smb2, struct smb2_pdu* pdu, struct smb2_set_info_request* req) {
    int                                i, len;
    uint16_t                           ch;
    uint8_t*                           buf;
    ...
    switch (req->info_type) {
        case SMB2_0_INFO_FILE:
            ...
            break;
        default:
            smb2_set_error(smb2, "Can not encode file info_type %d yet", req->info_type);
            return -1;
    }
...
struct smb2_pdu* smb2_cmd_set_info_async(struct smb2_context* smb2, struct smb2_set_info_request* req, smb2_command_cb cb, void* cb_data) {
    struct smb2_pdu* pdu;
...
int smb2_process_set_info_fixed(struct smb2_context* smb2, struct smb2_pdu* pdu) {
    return 0;
}
