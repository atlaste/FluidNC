...
void smb2_set_version(struct smb2_context* smb2, enum smb2_negotiate_version version);
 ...
 * this interface.
 */
void smb2_add_compound_pdu(struct smb2_context* smb2, struct smb2_pdu* pdu, struct smb2_pdu* next_pdu);
 ...
 */
struct smb2dirent* smb2_readdir(struct smb2_context* smb2, struct smb2dir* smb2dir);
 ...
 * Sync statvfs()
 */
int smb2_statvfs(struct smb2_context* smb2, const char* path, struct smb2_statvfs* statvfs);
