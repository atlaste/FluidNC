...
struct smb2dir* smb2_opendir(struct smb2_context* smb2, const char* path) {
    ...
    if (smb2_opendir_async(smb2, path, opendir_cb, cb_data) != 0) {
...
struct smb2fh* smb2_open(struct smb2_context* smb2, const char* path, int flags) {
    ...
    if (smb2_open_async(smb2, path, flags, open_cb, cb_data) != 0) {
...
int smb2_pread(struct smb2_context* smb2, struct smb2fh* fh, uint8_t* buf, uint32_t count, uint64_t offset) {
    ...
    rc = smb2_pread_async(smb2, fh, buf, count, offset, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_pwrite(struct smb2_context* smb2, struct smb2fh* fh, const uint8_t* buf, uint32_t count, uint64_t offset) {
    ...
    rc = smb2_pwrite_async(smb2, fh, buf, count, offset, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_read(struct smb2_context* smb2, struct smb2fh* fh, uint8_t* buf, uint32_t count) {
    ...
    rc = smb2_read_async(smb2, fh, buf, count, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_write(struct smb2_context* smb2, struct smb2fh* fh, const uint8_t* buf, uint32_t count) {
    ...
    rc = smb2_write_async(smb2, fh, buf, count, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_unlink(struct smb2_context* smb2, const char* path) {
    ...
    rc = smb2_unlink_async(smb2, path, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_rmdir(struct smb2_context* smb2, const char* path) {
    ...
    rc = smb2_rmdir_async(smb2, path, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_mkdir(struct smb2_context* smb2, const char* path) {
    ...
    rc = smb2_mkdir_async(smb2, path, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_fstat(struct smb2_context* smb2, struct smb2fh* fh, struct smb2_stat_64* st) {
    ...
    rc = smb2_fstat_async(smb2, fh, st, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_stat(struct smb2_context* smb2, const char* path, struct smb2_stat_64* st) {
    ...
    rc = smb2_stat_async(smb2, path, st, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_rename(struct smb2_context* smb2, const char* oldpath, const char* newpath) {
    ...
    rc = smb2_rename_async(smb2, oldpath, newpath, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_statvfs(struct smb2_context* smb2, const char* path, struct smb2_statvfs* st) {
    ...
    rc = smb2_statvfs_async(smb2, path, st, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_truncate(struct smb2_context* smb2, const char* path, uint64_t length) {
    ...
    rc = smb2_truncate_async(smb2, path, length, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
int smb2_ftruncate(struct smb2_context* smb2, struct smb2fh* fh, uint64_t length) {
    ...
    rc = smb2_ftruncate_async(smb2, fh, length, generic_status_cb, cb_data);
    if (rc < 0) {
        goto out;
    }
...
static void readlink_cb(struct smb2_context* smb2, int status, void* command_data, void* private_data) {
    struct sync_cb_data*     cb_data = private_data;
