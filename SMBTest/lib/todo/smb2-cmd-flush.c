...
static int smb2_encode_flush_request(struct smb2_context* smb2, struct smb2_pdu* pdu, struct smb2_flush_request* req) {
    int                len;
    uint8_t*           buf;
...
struct smb2_pdu* smb2_cmd_flush_async(struct smb2_context* smb2, struct smb2_flush_request* req, smb2_command_cb cb, void* cb_data) {
    struct smb2_pdu* pdu;
...
int smb2_process_flush_fixed(struct smb2_context* smb2, struct smb2_pdu* pdu) {
    return 0;
}
