...
p_syntax_id_t ndr32_syntax = { { NDR32_UUID }, 2 };

p_syntax_id_t ndr64_syntax = { { NDR64_UUID }, 1 };
...
int dcerpc_set_uint8(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint8_t value) {
...
int dcerpc_set_uint16(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint16_t value) {
...
int dcerpc_set_uint32(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint32_t value) {
...
int dcerpc_get_uint16(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint16_t* value) {
    uint16_t val;
...
int dcerpc_get_uint32(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint32_t* value) {
    uint32_t val;
...
int dcerpc_get_uint64(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint64_t* value) {
    uint64_t val;
...
int dcerpc_set_uint64(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, uint64_t value) {
    if (offset + sizeof(uint64_t) > iov->len) {
        return -1;
    }
    if (!(ctx->packed_drep[0] & DCERPC_DR_LITTLE_ENDIAN)) {
...
int dcerpc_connect_context_async(struct dcerpc_context* dce, const char* path, p_syntax_id_t* syntax, dcerpc_cb cb, void* cb_data) {
    dce->call_id = 2;
    dce->path    = strdup(path);
    if (dce->path == NULL) {
        smb2_set_error(dce->smb2,
                       "Failed to allocate path for "
                       "dcercp context.");
        return -ENOMEM;
    }
    dce->syntax         = syntax;
...
struct dcerpc_pdu* dcerpc_allocate_pdu(struct dcerpc_context* dce, int direction, int payload_size) {
...
static void dcerpc_add_deferred_pointer(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, dcerpc_coder coder, void* ptr) {
    pdu->ptrs[pdu->max_ptr].coder = coder;
    pdu->ptrs[pdu->max_ptr].ptr   = ptr;
    pdu->max_ptr++;
}

static int dcerpc_process_deferred_pointers(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset) {
...
static int dcerpc_decode_32(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (offset < 0) {
        return offset;
    }
...
static int dcerpc_encode_32(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
...
int dcerpc_uint32_coder(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
...
static int dcerpc_decode_16(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (offset < 0) {
        return offset;
    }
...
static int dcerpc_encode_16(struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
...
int dcerpc_uint16_coder(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (pdu->direction == DCERPC_DECODE) {
...
static int dcerpc_decode_8(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (offset < 0) {
        return offset;
    }
...
static int dcerpc_encode_8(struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
...
int dcerpc_uint8_coder(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (pdu->direction == DCERPC_DECODE) {
...
static int dcerpc_encode_3264(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
...
static int dcerpc_decode_3264(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    uint32_t u32 = 0;
...
int dcerpc_uint3264_coder(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (pdu->direction == DCERPC_DECODE) {
...
static int dcerpc_encode_ptr(
    struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr, enum ptr_type type, dcerpc_coder coder) {
...
int dcerpc_ptr_coder(
    struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr, enum ptr_type type, dcerpc_coder coder) {
    if (pdu->direction == DCERPC_DECODE) {
        return dcerpc_decode_ptr(dce, pdu, iov, offset, ptr, type, coder);
    } else {
        return dcerpc_encode_ptr(dce, pdu, iov, offset, ptr, type, coder);
    }
}

static int dcerpc_encode_utf16(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr, int nult) {
    uint16_t      zero = 0;
    int           i;
    uint64_t      val;
    struct utf16* utf16;
...
static int dcerpc_decode_utf16(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr, int nult) {
...
/* ptr is char ** */
int dcerpc_utf16z_coder(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (pdu->direction == DCERPC_DECODE) {
...
int dcerpc_utf16_coder(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (pdu->direction == DCERPC_DECODE) {
...
static int dcerpc_encode_header(struct dcerpc_context* dce, struct smb2_iovec* iov, struct dcerpc_header* hdr) {
    /* Major Version */
...
static int dcerpc_decode_header(struct smb2_iovec* iov, struct dcerpc_header* hdr) {
    /* Major Version */
...
static int dcerpc_encode_uuid(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, dcerpc_uuid_t* uuid) {
    if (offset < 0) {
        return offset;
    }
...
static int dcerpc_decode_uuid(struct dcerpc_context* ctx, struct smb2_iovec* iov, int offset, dcerpc_uuid_t* uuid) {
    uint8_t ch;
    int     i;
 ...
 * } ndr_context_handle;
 **********************/
static int dcerpc_context_handle_encoder(struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    struct ndr_context_handle* handle = ptr;

    dcerpc_set_uint32(dce, iov, offset, handle->context_handle_attributes);
    offset += 4;

    offset = dcerpc_encode_uuid(dce, iov, offset, &handle->context_handle_uuid);
    return offset;
}

static int dcerpc_context_handle_decoder(struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    struct ndr_context_handle* handle = ptr;

    dcerpc_get_uint32(dce, iov, offset, &handle->context_handle_attributes);
    offset += 4;

    offset = dcerpc_decode_uuid(dce, iov, offset, &handle->context_handle_uuid);

    return offset;
}

int dcerpc_context_handle_coder(struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov, int offset, void* ptr) {
    if (pdu->direction == DCERPC_DECODE) {
...
static int dcerpc_encode_bind(struct dcerpc_context* ctx, struct dcerpc_bind_pdu* bind, struct smb2_iovec* iov, int offset) {
    if (offset < 0) {
        return offset;
    }
...
static int dcerpc_encode_request(struct dcerpc_context* ctx, struct dcerpc_request_pdu* req, struct smb2_iovec* iov, int offset) {
    if (offset < 0) {
        return offset;
    }
...
static int dcerpc_encode_pdu(struct dcerpc_context* dce, struct dcerpc_pdu* pdu, struct smb2_iovec* iov) {
    int offset = 0;
    ...
    switch (pdu->hdr.PTYPE) {
        ...
        case PDU_TYPE_REQUEST:
            ...
            break;
        default:
            smb2_set_error(dce->smb2, "DCERPC No encoder for PDU type %d", pdu->hdr.PTYPE);
            return -1;
    }
...
static int dcerpc_decode_bind_ack(struct dcerpc_context* ctx, struct dcerpc_bind_ack_pdu* bind_ack, struct smb2_iovec* iov, int offset) {
    int      i;
    ...
    for (i = 0; i < bind_ack->num_results; i++) {
        ...
        offset = dcerpc_decode_uuid(ctx, iov, offset, &bind_ack->results[i].uuid);

        smb2_get_uint32(iov, offset, &bind_ack->results[i].syntax_version);
        offset += 4;
    }
...
static int dcerpc_decode_response(struct dcerpc_context* ctx, struct dcerpc_response_pdu* rsp, struct smb2_iovec* iov, int offset) {
#ifndef _MSC_VER
    ...
    if (rsp->alloc_hint > 16 * 1024 * 1024) {
        smb2_set_error(ctx->smb2,
                       "DCERPC RESPONSE alloc_hint out "
                       "of range.");
        return -1;
    }
...
static int dcerpc_decode_pdu(struct dcerpc_context* ctx, struct dcerpc_pdu* pdu, struct smb2_iovec* iov) {
    int offset = 0;
    ...
    switch (pdu->hdr.PTYPE) {
        ...
        case PDU_TYPE_RESPONSE:
            ...
            break;
        default:
            smb2_set_error(ctx->smb2, "DCERPC No decoder for PDU type %d", pdu->hdr.PTYPE);
            return -1;
    }
...
static void dce_unfragment_ioctl(struct dcerpc_context* dce, struct smb2_iovec* iov) {
    int                  offset = 0;
    int                  unfragment_len;
    ...
    if (hdr.rpc_vers != 5 || hdr.rpc_vers_minor != 0 || hdr.PTYPE != PDU_TYPE_RESPONSE) {
        return;
    }
    ...
    do {
        ...
        memmove(iov->buf + unfragment_len, iov->buf + offset + 24, next_hdr.frag_length - 24);
...
static void dcerpc_call_cb(struct smb2_context* smb2, int status, void* command_data, void* private_data) {
...
int dcerpc_call_async(
    struct dcerpc_context* dce, int opnum, dcerpc_coder encoder, void* ptr, dcerpc_coder decoder, int decode_size, dcerpc_cb cb, void* cb_data) {
    struct dcerpc_pdu*        pdu;
...
static void dcerpc_bind_cb(struct dcerpc_context* dce, int status, void* command_data, void* cb_data) {
...
static void smb2_bind_cb(struct smb2_context* smb2, int status, void* command_data, void* private_data) {
    struct dcerpc_pdu*       pdu = private_data;
    struct dcerpc_context*   dce = pdu->dce;
    struct smb2_iovec        iov;
    struct smb2_ioctl_reply* rep = command_data;
...
static int dcerpc_bind_async(struct dcerpc_context* dce, dcerpc_cb cb, void* cb_data) {
    struct dcerpc_pdu*        pdu;
    struct smb2_pdu*          smb2_pdu;
    struct smb2_ioctl_request req;
    struct smb2_iovec         iov;
...
static void smb2_open_cb(struct smb2_context* smb2, int status, void* command_data, void* private_data) {
    struct dcerpc_cb_data*    data = private_data;
    struct smb2_create_reply* rep  = command_data;
    struct dcerpc_context*    dce  = data->dce;

    if (status != SMB2_STATUS_SUCCESS) {
        data->cb(dce, -nterror_to_errno(status), NULL, data->cb_data);
        free(data);
        return;
    }
...
int dcerpc_open_async(struct dcerpc_context* dce, dcerpc_cb cb, void* cb_data) {
    ...
    if (data == NULL) {
        smb2_set_error(dce->smb2,
                       "Failed to allocate dcerpc callback "
                       "data");
        return -ENOMEM;
    }
    data->dce     = dce;
    ...
    req.desired_access         = SMB2_FILE_READ_DATA | SMB2_FILE_WRITE_DATA | SMB2_FILE_APPEND_DATA | SMB2_FILE_READ_EA |
