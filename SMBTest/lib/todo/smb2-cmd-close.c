...
static int smb2_encode_close_request(struct smb2_context* smb2, struct smb2_pdu* pdu, struct smb2_close_request* req) {
    int                len;
    uint8_t*           buf;
...
struct smb2_pdu* smb2_cmd_close_async(struct smb2_context* smb2, struct smb2_close_request* req, smb2_command_cb cb, void* cb_data) {
    struct smb2_pdu* pdu;
...
int smb2_process_close_fixed(struct smb2_context* smb2, struct smb2_pdu* pdu) {
