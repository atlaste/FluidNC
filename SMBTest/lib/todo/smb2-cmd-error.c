...
int smb2_process_error_fixed(struct smb2_context* smb2, struct smb2_pdu* pdu) {
...
int smb2_process_error_variable(struct smb2_context* smb2, struct smb2_pdu* pdu) {
