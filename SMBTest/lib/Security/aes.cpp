 ...
 *
 * This code has been heavily changed by Stefan de Bruijn.
 */
...
namespace Security
{
    ...
    static const uint8_t Rcon[255] = {
        ,
    ...
    /* Private functions:                                                        */
    /*****************************************************************************/
    uint8_t AES::getSBoxValue(uint8_t num) {
        return sbox[num];
    }

    uint8_t AES::getSBoxInvert(uint8_t num) {
        return rsbox[num];
    }
    ...
    void AES::AddRoundKey(uint8_t* roundKey, state_t* state, uint8_t round) {
        uint8_t i, j;
        for (i = 0; i < 4; ++i) {
            for (j = 0; j < 4; ++j) {
    ...
    void AES::Cipher(uint8_t* roundKey, state_t* state) {
        uint8_t round = 0;
    ...
    void AES::InvCipher(uint8_t* roundKey, state_t* state) {
        uint8_t round = 0;
    ...
    void AES::BlockCopy(uint8_t* output, uint8_t* input) {
        uint8_t i;
        for (i = 0; i < KEYLEN; ++i) {
            output[i] = input[i];
        }
    ...
    void AES::AES128_ECB_encrypt(uint8_t* input, const uint8_t* key, uint8_t* output) {
    ...
    void AES::AES128_ECB_decrypt(uint8_t* input, const uint8_t* key, uint8_t* output) {
        // Copy input to output, and work in-memory on output
        BlockCopy(output, input);
